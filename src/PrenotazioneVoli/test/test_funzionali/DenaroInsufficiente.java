...
/**
 * 
 * Scenario alternativo dello use case di Prenotazione Volo in cui
 * si vuole comprare un volo che costa di più di quanto denaro si possegga sulla carta
 * 
 * @author se-17-user
 *
 */

public class DenaroInsufficiente {
	...
	public void test() {
		...
		when(test.nextInt()).thenReturn(1251);	
		p.setTest(test);
		Boolean res = false;
		...
		assertEquals("Sbagliato", 1250, p.getImporto(),0.0);
	}
