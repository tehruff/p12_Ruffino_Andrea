...
/**
 * Scenario principale dello use case Prenotazione Volo.
 * Ogni selezione è eseguita in maniera corretta fino al raggiungimento dell'obiettivo.
 * 
 * 
 * @author se-17-user
 *
...
public class PrenotazioneVoloPrincipale {
	...
	public void test() {
		...
		when(test.nextInt()).thenReturn(1);	
		p.setTest(test);
		...
		when(test.nextInt()).thenReturn(9);	
		p.setTest(test);
		...
		//when(test.nextInt()).thenReturn(99);	
		p.setTest(test);
